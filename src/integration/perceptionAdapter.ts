import { UnifiedPerceptionResult, DetectionResult, BoundingBox } from '../schema/detection.js';
...
export class PerceptionAdapter {
   ...
   */
  public static boxesOverlap(boxA: BoundingBox, boxB: BoundingBox): boolean {
   ...
   */
  public static mergePerceptionWithDOM(
    domElements: ElementInfo[],
    perceptionResult: UnifiedPerceptionResult
  ): ElementInfo[] {
    const mergedElements: ElementInfo[] = [...domElements];
