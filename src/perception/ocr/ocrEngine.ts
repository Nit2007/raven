...
import { OcrCoordinateConverter, RawOcrBBox } from './ocrCoordinateConverter.js';
import { NormalizedOcrRegion, OcrTokenNormalizer } from './ocrTokenNormalizer.js';
...
export class LocalOcrEngine implements IOcrEngine {
  ...
  private engineInfo = 'Tesseract.js WASM Engine (v5 Local)';
  private normalizer = new OcrTokenNormalizer();
  ...
  public async recognizeText(
    ...
    try {
      ...
      const detections: DetectionResult[] = normalizedRegions.map((norm, idx) => ({
