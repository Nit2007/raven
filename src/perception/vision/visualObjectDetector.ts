...
export class LocalVisualObjectDetector {
  ...
  private confidenceThreshold = 0.50;
  ...
  private extractMultiModalDocumentRegions(
    ...
    for (const w of words) {
      ...
      let matchedCat: VisualSensitiveCategory | null = null;
    ...
    if (minX < maxX && minY < maxY) {
      ...
      let targetCategory: VisualSensitiveCategory = 'ID_DOCUMENT';
      let confidence = 0.85;
      ...
      if (confidence >= this.confidenceThreshold) {
        results.push(LocalVisualObjectDetector.createVisualDetection(
   ...
   */
  public static createVisualDetection(
    id: string,
