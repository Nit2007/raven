...
Tests:
  ...
  8. POST /agent/act (PII leak screen state)
...
def test_endpoints():
    ...
    assert r.status_code == 200
    print("[PASS] POST /agent/act (PII Leak) -> Processed smoothly without 500 error.")

    # 8. Act Endpoint with Hallucinated Step
