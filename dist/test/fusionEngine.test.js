...
test('TEST 6 - Duplicate detection', () => {
    const fusion = new PerceptionFusionEngine();
    const dupFace1 = { id: 'f1', type: 'FACE', source: 'face', bbox: { x: 100, y: 100, width: 80, height: 80 }, confidence: 0.95 };
    const dupFace2 = { id: 'f2', type: 'FACE', source: 'face', bbox: { x: 102, y: 102, width: 80, height: 80 }, confidence: 0.80 };
...
test('TEST 10 - Confidence preservation', () => {
    const fusion = new PerceptionFusionEngine();
    const det = { id: 'c1', type: 'FACE', source: 'face', bbox: { x: 50, y: 50, width: 60, height: 60 }, confidence: 0.887 };
    const unified = fusion.buildUnifiedResult({
        screenshotWidth: 1920,
        screenshotHeight: 1080,
